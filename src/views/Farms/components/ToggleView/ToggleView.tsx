  ...
  return (
    ...
    >
      <g
        id="Group_521"
        data-name="Group 521"
        transform="translate(-606 -366.788)"
      >
        <rect
          id="Rectangle_281"
        ...
        <g id="Group_520" data-name="Group 520" transform="translate(1 0.131)">
          <rect
            ...
            height="13"
            rx="2"
            transform="translate(627 371.657) rotate(90)"
            fill={color}
          />
          <rect
            id="Rectangle_171"
            ...
            height="13"
            rx="2"
            transform="translate(627 376.657) rotate(90)"
            fill={color}
          />
          <rect
            id="Rectangle_172"
            ...
            height="13"
            rx="2"
            transform="translate(627 381.657) rotate(90)"
            fill={color}
          />
          <rect
            id="Rectangle_173"
            ...
            height="5"
            rx="2"
            transform="translate(613 371.657) rotate(90)"
            fill={color}
          />
          <rect
            id="Rectangle_174"
            ...
            height="5"
            rx="2"
            transform="translate(613 376.657) rotate(90)"
            fill={color}
          />
          <rect
            id="Rectangle_175"
            ...
            height="5"
            rx="2"
            transform="translate(613 381.657) rotate(90)"
            fill={color}
          />
        </g>
      </g>
