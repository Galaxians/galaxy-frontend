...
export const ChildDiv = styled.div`
  flex: 1;
  background: transparent linear-gradient(132deg, #61319f 0%, #311950 100%) 0%
...
export default function DeveloperPad({ GoBack }: { GoBack: () => void }) {
  ...
  return (
    <DeveloperDiv>
      {activeIndex === 0 ? (
        ...
        <BackDiv onClick={() => setIndex(0)}>
          <ChevronLeftIcon style={{ fill: "#FF1FFF", zoom: "1.5" }} /> Go back
        </BackDiv>
      )}
      <Header>Nebula Launchpad</Header>
      <HDescription>Launch your token easily</HDescription>

      {activeIndex === 0 ? (
        <FirstDiv>
          <div>Choose the services you would like to use</div>
          <div>
            <ChildDiv onClick={() => setIndex(1)}>
              ...
              >
                Kickstart you Blockchain project, raise your capital and rock
                the crypto world!
              </div>
            </ChildDiv>
      ...
      {activeIndex === 1 ? (
        <div style={{ display: "flex", justifyContent: "center" }}>
          <MainDiv>
            <LaunchpadTitle>Nebula Lanunchpad</LaunchpadTitle>
            <div className="nebula-class">
              <PresaleDiv>Create your presale</PresaleDiv>
              {!tokenCheck ? (
                <PresaleDetail>
                  ...
                  <Text style={{ marginTop: "20px", fontSize: "12px" }}>
                    GalaxySwap V2 par to created
                  </Text>
                  <Text style={{ fontSize: "12px", color: "#FF1FFF" }}>
                    WBNB/?
                  </Text>
                </PresaleDetail>
              ) : (
                <PresaleDetail>
                  ...
                  <div style={{ marginTop: "20px", fontSize: "12px" }}>
                    GalaxySwap V2 par to be created
                  </div>
                  <div
                    style={{
                      marginTop: "5px",
                  ...
                  <div style={{ fontSize: "12px", color: "#FF1FFF" }}>
                    0x2dbd...54Cc
                  </div>
                  <div style={{ marginTop: "20px", fontSize: "12px" }}>
                    This account will be the only account capable of adding
                    presale information, editing presale contract paramaters and
                    unlocking liquidity.
                  </div>
                  <NBPrediv>
                    We recomend a minimum liquidity percentage of 60%, and a
                    minimum lock of 1 year.
                  </NBPrediv>
                  <SmallText marginTop="20px">
                    How many SAFEGALAXY are up for presale?
                  </SmallText>
                  <PreDiv>
                    <div
                      style={{
                  ...
                  >
                    A minimum divisibility of 10,000 units (including decimals)
                    is required for a presale.
                  </div>
                  <div
                    style={{
                      marginTop: "20px",
                  ...
                  >
                    ...
                    <div style={{ display: "flex" }}>
                      <div style={{ flex: 1, marginRight: "20px" }}>
                        ...
                        >
                          ...
                          <div style={{ fontWeight: 700 }}>WBNB</div>
                        </PreDiv>
                      </div>
                      <div style={{ flex: 1 }}>
                        <PreDiv
                    ...
                    <div style={{ display: "flex", marginTop: "10px" }}>
                      <div style={{ flex: 1 }} />
                      <div style={{ flex: 1 }}>
                        <SmallText color="#FF1FFF">Must be{">"}0</SmallText>
                      </div>
                    </div>
                  </div>
                  <div style={{ marginTop: "20px", fontSize: "12px" }}>
                  ...
                  <PreDiv style={{ width: "90%", padding: "25px" }}>
                    ...
                    >
                      Amount of tokens for public sale
                    </div>
                    <div
                      style={{
                        fontSize: "14px",
                    ...
                    >
                      Amount of tokens for developers
                    </div>
                    <div
                      style={{
                        fontSize: "14px",
                  ...
                  >
                    ...
                    >
                      <div style={{ flex: 1 }}>
                        <SmallText color="#FF1FFF">Must be above 0</SmallText>
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <MiniText>
                        Presale should ideally start 1 week from today to give
                  ...
                  >
                    <ProDiv>
                      Please note: If the presale is a success, any unsold
                      tokens are sent to the 0x00…dEaD burn address.
                    </ProDiv>
                  </div>
      ...
      {activeIndex === 2 ? (
        <div style={{ display: "flex", justifyContent: "center" }}>
          <MainDiv>
            <LaunchpadTitle>High Security Token Locker</LaunchpadTitle>
            <div className="token-class">
              <BlurDiv>
                <ZoomText>
                  We bring you the High Security Token Locker. Token locks are
                  represented as shares of a pool, in a similar way to a
                  GalaxySwap pool, allowing all BEP20 tokens including Rebasing
                  and Deflationary mechanisms to be supported. This means lock
                  amounts may change due to decimal rounding, but you will
                ...
                <ZoomDiv>
                  ...
                  <ChevronDownIcon
                    style={{ marginLeft: "5px", fill: "#FF1FFF" }}
                  />
                </ZoomDiv>
                <SearchDiv>
                  <div
      ...
      {activeIndex === 3 ? (
        <div style={{ display: "flex", justifyContent: "center" }}>
          <MainDiv>
            <LaunchpadTitle>Intergalactic Liquidity Locker</LaunchpadTitle>
            <div className="liquidity-class">
              <BlurDiv>
                <ZoomText>
                  The intergalactic Liquidity Locker does say his name. It locks
                  your tokens. That way you will gain trust amongst your
                  investors. If you are not developing a token this section is
                  not ment for you. Instead we kindly direct you to{" "}
                  <span style={{ fontWeight: 900 }}>this</span>
                </ZoomText>
                <Text
                  style={{
                    fontSize: "12px",
                ...
                >
                  Enter the GalaxySwap V1 pair address you would like to lock
                  liquidity for
                </Text>
                <div
                  style={{
                  ...
                  <>
                    <div
                      style={{
                        ...
                        flexDirection: "column",
                        marginTop: "10px",
                        border: "0.5 solid #FF1FFF",
                        borderRadius: "8px",
                        background: "#760FA0 0% 0% no-repeat padding-box",
                        padding: "10px",
                        color: "white",
                      }}
                    >
                    ...
                    <Text style={{ marginTop: "10px", fontWeight: 700 }}>
                      0 SAFEGALAXY
                    </Text>
                  </>
                )}
