            ...
            {!isMobile ? <>
                <div style={{ flex: 1.5, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ display: 'flex', margin: '25px 0px', padding: '5px' }}>
                        <div style={{ width: '150px', position: 'relative', display: 'flex' }}>
                            <img src="./assets/img/Kal-with-tongue-out.png" alt="tongue" style={{ width: '150px' }} />
                            <div style={{ position: 'absolute', color: 'black', fontSize: '14px', right: -25, top: -50, background: 'white', borderRadius: '100%', width: '100px', height: '100px', display: 'flex', alignItems: 'center', textAlign: 'center', fontWeight: 'bold' }}>Token Logo Here</div>
                        </div>
                ...
                <div style={{width: '100%'}}>
                    <div style={{ display: 'flex', width: '100%' }}>
                        <div style={{ width: '120px', position: 'relative', display: 'flex' }}>
                            <img src="./assets/img/Kal-with-tongue-out.png" alt="tongue" style={{ width: '120px' }} />
                            <div style={{ position: 'absolute', color: 'black', fontSize: '10px', right: -20, top: -30, background: 'white', borderRadius: '100%', width: '75px', height: '75px', display: 'flex', alignItems: 'center', textAlign: 'center', fontWeight: 'bold' }}>Token Logo Here</div>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '50px', width: 'calc(100% - 170px)', fontSize: '12px' }}>
                            <div>
                                <span style={{ fontWeight: 800 }}>Sale ends in</span>: 00:11:23:10
                            </div>
                            <div style={{ position: 'relative', background: '#3F064E', width: '100%', height: '12px', borderRadius: '10px', marginTop: '10px' }}>
                    ...
                    <Body>
                        ...
                        <Footer>
                            <div>
                                <span style={{ fontWeight: 600 }}>Presale Address: </span><span style={{ fontWeight: 'lighter' }}>0x45ce53b...b7500A</span>
                            </div>
                            <div style={{ marginTop: '15px' }}>
                                <span style={{ fontWeight: 600 }}>Token Address: </span><span style={{ fontWeight: 'lighter' }}>0xC512261...150B90C0</span>
                            </div>
                            <div style={{ marginTop: '3px', color: '#FF1FFF', fontSize: '12px' }}>Do not send BNB to the token address</div>
                            <div style={{ marginTop: '10px'}}>
                                <a href="https://discord.com/invite/dq7m6R7UAz" target='_blank' rel="noreferrer" style={{ padding: '5px' }}>
                                    <img src="./assets/img/icon-1.png" alt="" width="25px" />
                                </a>
