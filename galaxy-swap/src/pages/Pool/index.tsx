...
export default function Pool() {
  ...
  return (
    <Page style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ width: '100%' }}>
        <AppBody>
          ...
          <Button
            ...
            style={{ width: '94%', marginLeft: '3%', borderRadius: '4px' }}
            id="join-pool-button"
            as={Link}
            to="/add/BNB"
          >
          ...
          <AutoColumn justify="center">
            <CardBody>
              <AutoColumn gap="12px" style={{ margin: '10px' }}>
                ...
                {!account ? (
                  <LightCard
                    style={{ width: '98%', marginLeft: '1%', borderRadius: '6px', borderColor: '#696272', background: '#696272' }}
                    padding="20px"
                  >
                ...
                <div>
                  <Text fontSize="14px" style={{ marginLeft: '5px', padding: '.5rem 0 .5rem 0' }}>
