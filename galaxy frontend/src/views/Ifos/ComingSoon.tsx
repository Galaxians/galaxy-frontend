    ...
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">
              {TranslateString(999, "Coming Soon to Galaxia.")}
            </Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              {TranslateString(
                508,
                "The project gets the BNB, Galaxia burns the CAKE."
              )}
              <br />
          ...
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                "Launch your project with Galaxia, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC."
              )}
            </Text>
            <Button
              as="a"
