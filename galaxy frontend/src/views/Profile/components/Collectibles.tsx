...
import { Heading, Text, Flex, ChevronRightIcon } from "glx-uikit";
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, "Galaxia Collectibles")}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          "Galaxia Collectibles are special ERC-721 NFTs that can be used on the Galaxia platform."
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Galaxia Collectibles won't be shown here."
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">
          {TranslateString(999, "See all approved Galaxia Collectibles")}
        </Link>
        <ChevronRightIcon />
      </Flex>
    </>
